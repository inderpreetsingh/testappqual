...
@property (nonatomic, strong) NSString *matchLoadid;
@property (nonatomic, strong) NSString *pickupLatitude;
@property (nonatomic, strong) NSString *parentId;
@property (nonatomic, strong) NSString *matchesIdentifier;
@property (nonatomic, strong) NSString *offerRate;
@property (nonatomic, strong) NSString *modifiedDate;
@property (nonatomic, strong) NSString *isTest;
@property (nonatomic, strong) NSString *isContacted;
@property (nonatomic, strong) NSString *pickupState;
@property (nonatomic, strong) NSString *userId;
@property (nonatomic, strong) NSString *companyName;
@property (nonatomic, strong) NSString *state;
@property (nonatomic, strong) NSString *matchEquiid;
@property (nonatomic, strong) NSString *matchDistance;
...
@property (nonatomic, strong) NSString *matchOrderStatus;
@property (nonatomic, strong) NSString *userLatitude;
@property (nonatomic, strong) NSString *address;
@property (nonatomic, strong) NSString *matchToId;
...
@property (nonatomic, strong) NSString *matchFromId;
...
@property (nonatomic, strong) NSString *dotAddresses;
...
@property (nonatomic, strong) NSString *delievryStateCode;
