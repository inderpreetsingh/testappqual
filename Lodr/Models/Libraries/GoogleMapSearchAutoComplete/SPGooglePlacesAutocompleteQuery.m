...
@synthesize input, sensor, key, offset, location1, radius, language, types, resultBlock;
...
- (id)init {
    ...
    if (self) {
        ...
        self.sensor = YES;
        self.key = GoogleMapAPIKey;
        self.offset = NSNotFound;
       // self.location1 = CLLocationCoordinate2DMake(25.276987, 55.296249);
...
- (NSString *)googleURLString {
    ...
    if (location1.latitude != -1) {
        [url appendFormat:@"&location=%f,%f", location1.latitude, location1.longitude];
    }
