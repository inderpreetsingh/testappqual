...
#define FTDefaultMenuFont                   [UIFont systemFontOfSize:12.f]
#define FTDefaultMenuWidth                  150.f
#define FTDefaultMenuIconSize               12.f
#define FTDefaultMenuRowHeight              30.f
#define FTDefaultMenuBorderWidth            0.8
#define FTDefaultMenuArrowWidth             7.f
...
//    if(indexPath.row==[_selectedrow integerValue])
//    {
//        menuCell.menuNameLabel.textColor=[UIColor orangeColor];
//        //menuCell.backgroundColor=[UIColor orangeColor];
//    }
//    else
//    {
//        menuCell.menuNameLabel.textColor=[UIColor whiteColor];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _selectedrow=[NSString stringWithFormat:@"%ld",(long)indexPath.row];
    if (self.doneBlock)
    {
...
#warning pu added this line
        menuRect.origin.y=menuRect.origin.y-(FTDefaultMenuArrowHeight-1);
    }else
    {
       
        if([[FTPopOverMenuConfiguration defaultConfiguration].menuType  isEqualToString: @"TOP"])
        {
            menuArrowPoint.x=16;
        }
        else
        {
            menuArrowPoint.x=[FTPopOverMenuConfiguration defaultConfiguration].menuWidth - 16;
        }
        ...
        {
            menuRect.origin.y=menuRect.origin.y+1;
        }
    }
