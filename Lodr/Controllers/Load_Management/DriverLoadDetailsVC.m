...
@implementation DriverLoadDetailsVC
...
- (void)viewDidLoad
{
    ...
    if([_selectedLoad.isAllowComment isEqualToString:@"0"]){
...
{
    switch (section) {
        case LoadDetailsTopSectionListDriver:
            return 3;
            break;
        case LoadDetailsNotesSectionListDriver:
            return 3;
            break;
        case LoadDetailsCommentSectionListDriver:
        ...
        switch (indexPath.section) {
            ...
            case LoadDetailsTopSectionListDriver:{
                switch (indexPath.row){
                    case CellLoadsDetailTopListDriver:
                    {
                        ...
                        break;
                    case CellLoadsDetailMiddleListDriver:{
                        ...
                        break;
                    case CellLoadsDetailMiddleFieldsListDriver:{
            ...
            case LoadDetailsNotesSectionListDriver:{
                switch (indexPath.row) {
                    ...
                    case CellLoadsWithCVListDriver:{
                        ...
                        break;
                    case LoadDetailsAddPhotosListDriver:{
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    [objView.btnCancelLoad setTitle:ReportStatusButtonText forState:UIControlStateNormal];
    
 //   objView.btnNotIntHeightConstraints.constant = 0;
    [objView.btnCancelLoad setBackgroundColor:ThemeOrangeColor];
    
    objView.viewNotInterested.hidden = YES;
    objView.viewEditLoad.hidden = YES;
    objView.viewReportStatus.hidden = NO;
...
//    objView.viewNotInterested.hidden = YES;
    ...
    [objView.btnCancelLoad addTarget:self action:@selector(btnlinkscheduleconfirmclicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    if(!isCommentsAllowed){
        objView.commentViewHeightConstant.constant = 0;
        
        
    }
    else{
        objView.commentViewHeightConstant.constant = 173.0;
...
//        //cell.imgLarge.image = [UIImage imageNamed:@"noimage"];
//
//      //  return cell;
//
//
...
{
    CellWithCV *cellselected=(CellWithCV*)[_tblLoadDetail cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:1]];
//    CellWithCV *cellselected1=(CellWithCV*)[_tblLoadDetail cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:1]];
//    CellWithCV *cellselected2 = (CellWithCV*)[_tblLoadDetail cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:1]];
